      ...
      <div className="relative flex flex-col gap-4 items-center justify-center px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8">
          <Link 
            ...
            className="bg-black dark:bg-white border border-black dark:border-white rounded-full w-fit text-white dark:text-black px-6 py-3 font-semibold hover:bg-white hover:text-black dark:hover:bg-black dark:hover:text-white transition-all duration-300 hover:scale-105 hover:shadow-lg"
          >
            {locale === 'de' ? 'Über uns' : 'Hakkımızda'}
          </Link>
          <Link 
            href={`/${locale}/mitglied-werden`} 
            className="border border-black dark:border-white rounded-full w-fit text-black dark:text-white px-6 py-3 font-semibold hover:bg-black hover:text-white dark:hover:bg-white dark:hover:text-black transition-all duration-300 hover:scale-105 hover:shadow-lg"
          >
