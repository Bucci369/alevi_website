      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-gray-50 rounded-lg p-8 border border-gray-200">
            ...
            <a 
              href="/antrag-auf-mitgliedschaft-19-10-2014.pdf" 
              download="Mitgliedschaftsantrag-Alevitische-Gemeinde-Dortmund.pdf"
            ...
            >
              ...
              {locale === 'de' ? 'Formular herunterladen (PDF)' : 'Formu İndir (PDF)'}
            </a>
          </div>
        </div>
      </section>
