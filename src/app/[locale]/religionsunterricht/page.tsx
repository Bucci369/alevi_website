...
export default function ReligiousEducationPage({ params }: ReligiousEducationPageProps) {
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          {params.locale === 'de' ? 'Alevitischer Religionsunterricht (ARU)' : 'Alevi Din Dersi (ARU)'}
        </h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-12">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            {params.locale === 'de' ? 'Über den ARU' : 'ARU Hakkında'}
          </h2>
        ...
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-6">
            {params.locale === 'de' ? 'Verfügbare Bundesländer' : 'Mevcut Eyaletler'}
          </h2>
      ...
      <div className="bg-gray-50 rounded-lg p-8 text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-4">
          {params.locale === 'de' ? 'Jetzt auch an deiner Schule!' : 'Şimdi senin okulunda da!'}
        </h2>
        ...
        >
          {params.locale === 'de' ? 'Kontakt aufnehmen' : 'İletişime Geç'}
        </a>
      </div>
      </div>
    </div>
...
export function generateMetadata({ params }: ReligiousEducationPageProps) {
  const title = params.locale === 'de' 
    ? 'Alevitischer Religionsunterricht (ARU) - Alevitische Gemeinde Dortmund'
    : 'Alevi Din Dersi (ARU) - Dortmund Alevi Toplumu'
  
  const description = params.locale === 'de'
